...
export default function CommentSection({ postSlug, supabaseEdgeFunctionUrl, supabaseAnonKey }: CommentSectionProps) {
  ...
  return (
    <section className="mt-12 border-t border-gray-200 pt-10">
      <h3 className="mb-6 text-xl font-semibold text-gray-900">Comments</h3>
      ...
      {comments.length > 0 ? (
        ...
        <p className="mb-10 text-sm text-gray-500">No comments yet. Be the first!</p>
      )}

      <form onSubmit={handleSubmit} className="space-y-4">
        <h4 className="text-lg font-medium text-gray-900">Leave a comment</h4>
        ...
        {success && <p className="text-sm text-green-600">Comment posted!</p>}
        <button
          type="submit"
          disabled={submitting}
